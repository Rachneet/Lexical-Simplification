...
class FeaturePreprocessor(AbstractPreprocessor):
    ...
    def get_feature_name(self):
        return (f'{repr(self.feature_name)}')
    ...
    def encode_sentence(self, sentence, encoder_sentence=None):
        ...
        # print(f'{self.get_feature_token(desired_feature)} {sentence}')
...
class SentencePiecePreprocessor(AbstractPreprocessor):
    ...
    def sp(self):
        '''
        We need to use a property because SentencenPieceProcessor cannot be pickled
