...
This repository contains the implementation of the ACCESS model (**A**udien**C**e-**CE**ntric **S**entence **S**implification)  presented in [Controllable Sentence Simplification](https://arxiv.org/abs/1910.02677).
Modifications for the generation process have been added in order to use ACCESS as a service.
